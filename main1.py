...
def text_pdf():
    ...
    destination_path = 'D:\B.Tech--IT-2022-main\10_Grp_MultimodalSentimentAnalysis\code\tmp'
        # Ensure the destination directory exists
    os.makedirs(destination_path, exist_ok=True)
        
        # Save the file with the secure filename in the specified destination directory
    f.save(os.path.join(destination_path, secure_filename(f.filename)))
